  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative pt-20 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-bold tracking-tighter mb-6 bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent"
          >
          ...
          >
            <Link to="/register" className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all shadow-lg shadow-emerald-900/20">
              Get Started Now
            </Link>
            <Link to="/login" className="bg-slate-800 hover:bg-slate-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all">
              Login to Dashboard
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-24 px-6 bg-slate-900/50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 lg:grid-cols-5 gap-8">
          <FeatureCard 
